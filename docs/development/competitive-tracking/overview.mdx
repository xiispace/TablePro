...
4. Mark status against TablePro: `ALREADY_DONE`, `PARTIAL`, `MISSING`, or `OUT_OF_SCOPE`. Status comes from the `tablepro-feature-inventory.md` snapshot taken 2026-05-14.
...
After the merge and the closed-issue filter, 300 issues remain: 147 open and 153 closed.
